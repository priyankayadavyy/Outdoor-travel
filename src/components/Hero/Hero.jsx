...
const Hero = () => {
  return (
    <>
      <section className="min-h-[800px] flex justify-center items-center bg-gradient-to-t from-brandDark from-2% to-transparent to-15% h-full cursor-pointer">
        <div
        ...
        <motion.div
          ...
          className="container relative x-20 text-center space-y-8"
        >
          <h1 className="text-4xl md:text-8xl font-bold font-merriweather">
            The Great Outdoors
          </h1>
